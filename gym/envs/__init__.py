...
for reward_type in ['sparse', 'dense']:
    ...
    register(
        id='FetchPickAndThrow{}-v1'.format(suffix),
        entry_point='gym.envs.robotics:FetchPickAndThrowEnv',
        kwargs=kwargs,
        max_episode_steps=100,
    )
    ...
    register(
        ...
        entry_point='gym.envs.robotics:FetchPushNoObstacleEnv',
        kwargs=kwargs,
        max_episode_steps=100,
    )
    ...
    register(
        ...
        entry_point='gym.envs.robotics:FetchPushLabyrinthEnv',
        kwargs=kwargs,
        max_episode_steps=100,
    )
    ...
    register(
        id='FetchPickNoObstacle{}-v1'.format(suffix),
        entry_point='gym.envs.robotics:FetchPickNoObstacleEnv',
        kwargs=kwargs,
        max_episode_steps=100,
    )
    ...
    register(
        id='FetchReachNew{}-v1'.format(suffix),
        entry_point='gym.envs.robotics:FetchReachNewEnv',
        kwargs=kwargs,
        max_episode_steps=50,
    )
